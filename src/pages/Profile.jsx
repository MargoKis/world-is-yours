      ...
      <div className="w-screen pt-20 px-170 pb-150">
        ...
        <div className="flex  mt-50  flex-col xl:flex-row">
          ...
          <div className="min-w-235  h-80 flex flex-col items-start gap-2">
            ...
            <Button
              classNameBtn={`font-raleway text-base font-medium ${
                selectedComponent === "addresses" ? "underline text-black" : "text-gray"
              }`}
            ...
            <Button
              classNameBtn={`font-raleway text-base font-medium ${
                selectedComponent === "history" ? "underline text-black" : "text-gray"
              }`}
            ...
            <Button
              classNameBtn={`font-raleway text-base font-medium ${
                selectedComponent === "return" ? "underline text-black" : "text-gray"
              }`}
              onClickBtn={() => {
                dispatch(logout());
                Cookies.remove("user");
