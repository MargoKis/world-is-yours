...
//   const augmentedData = data.map(item => ({ ...item, actions: renderActions(item) }));
...
//         <button className="p-4 w-80 text-blue font-bold rounded-lg border border-blue bg-white">
//           Додати товар
//         </button>
...
//       <table {...getTableProps()} className="border-collapse border border-gray-300 rounded-lg">
//         <thead>
...
const ProductsList = ({ onAddProductClick }) => {
  ...
  return (
    <>
      <div className="flex flex-row justify-between mb-4">
        <button className="p-4 w-80 text-blue font-bold rounded-lg border border-blue bg-white" onClick={onAddProductClick}>
          Додати товар
        </button>
        <div className="flex flex-col">
          <p className="">Всього товарів - 100 000</p>
