        ...
        <div className='flex justify-between items-center gap-4 px-10 bg-white text-custom-black drop-shadow-5xl '>
          <div className='flex justify-start items-center'>
            ...
            <div className='mx-10 text-center flex flex-col'>
              <button className={`cursor-pointer hover:underline focus:underline ${locale === 'en' ? ' underline focus:scale-105' : 'text-custom-black/30'}`} onClick={() => dispatch(setLocale({ locale: 'en' }))}>
                ENG
              </button>

              <button className={`cursor-pointer hover:underline focus:underline ${locale === 'uk' ? ' underline focus:scale-105' : 'text-custom-black/30'}`} onClick={() => dispatch(setLocale({ locale: 'uk' }))}>
                UA
              </button>
            </div>
          ...
          <ul className='flex justify-center items-center gap-10 justify-self-center'>
            ...
            <li>
              <NavLink to={'/contacts'} className='hover:underline focus:underline'>
                {t('CONTACTS')}
              </NavLink>
            </li>
          </ul>
          ...
          <div className='flex justify-end items-center gap-5'>
            <NavLink to={'/cart'} className={({ isActive }) => (isActive ? currentPage : notCurrentPage)}>
              <svg className='w-10 h-10 stroke-current' viewBox='0 0 40 40' fill='none' xmlns='http://www.w3.org/2000/svg'>
                <path d='M15 30C15.5523 30 16 29.5523 16 29C16 28.4477 15.5523 28 15 28C14.4477 28 14 28.4477 14 29C14 29.5523 14.4477 30 15 30Z' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' />
                <path d='M26 30C26.5523 30 27 29.5523 27 29C27 28.4477 26.5523 28 26 28C25.4477 28 25 28.4477 25 29C25 29.5523 25.4477 30 26 30Z' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' />
                <path
