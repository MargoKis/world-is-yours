  ...
  return (
    <>
      ...
      <div className="flex justify-start gap-x-32   flex-col xxl:flex-row">
        ...
        <form className="left-side w-full max-w-md mb-10 ">
          ...
          <div className="flex gap-5 justify-between mt-5">
            <label
              htmlFor="userDate"
              className="w-2/7 text-darkGrey font-raleway text-4 font-medium"
            >
              День Народження
              <input
                id="userDate"
      ...
      <Button
        ...
        classNameBtn="flex w-500 justify-center items-center rounded-xl bg-custom-black p-5 text-white mt-8"
      >
        Зберегти
      </Button>
    </>
