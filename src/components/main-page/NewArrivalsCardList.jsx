...
const NewArrivalsCardList = () => {
  ...
  return (
    <Container className='justify-center text-grayLight' id='sectionFav'>
      <h1 className='flex items-center justify-center mt-20 mb-10 font-raleway text-custom-black text-30px'>Новинки</h1>
      <div className='grid grid-flow-row-dense gap-x-5 gap-y-[50px] grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 justify-center'>
        ...
        {next ? (
          <div className=' m-3 border-2 border-gray-light rounded-lg relative w-90 items-center cursor-pointer' onClick={loadMoreCards}>
            <div className='flex justify-center items-center px-1 h-full min-h-[27rem]'>
              <div className='w-80 max-w-200 flex justify-center items-center '>
                <div className='flex flex-col items-center justify-center '>
                  <p className="text-neutral-900 text-[25px] font-semibold font-['Raleway']">{t('see more')}</p>
